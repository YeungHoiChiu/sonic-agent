...
public class ScrcpyLocalThread extends Thread {
    ...
    public void run() {
        ...
        try {
            iDevice.executeShellCommand("CLASSPATH=/data/local/tmp/sonic-android-scrcpy.jar app_process / com.genymobile.scrcpy.Server v3.1 log_level=info max_size=0 max_fps=60 tunnel_forward=true send_frame_meta=false send_device_meta=false control=false show_touches=false stay_awake=false power_off_on_close=false clipboard_autosync=false",
